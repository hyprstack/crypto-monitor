...
nconf.defaults({
  ...
  'PRIVATE_KEY': fs.readFileSync('./lib/config/local-keys/my-server.key.pem'),
  'PUBLIC_KEY': fs.readFileSync('./lib/config/local-keys/client/my-server.pub'),
  'SECRET-KEY': 'CRYPTO_WATCH'
});
